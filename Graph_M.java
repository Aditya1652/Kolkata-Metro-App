...
import java.io.*;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        {
            g.addVertex("Dakhineswar~B");
            g.addVertex("Baranagar~B");
            g.addVertex("Noapara~B");
            g.addVertex("DumDum~B");
            g.addVertex("Belgachia~B");
            g.addVertex("Shyambazar~B");
            g.addVertex("Shobhabazar Sutanuti~B");
            ...
            g.addVertex("Kavi Subhash~B");
            
            g.addVertex("Phoolbagan~G");
            g.addVertex("IFA Salt Lake Stadium~G");
            g.addVertex("Bengal Chemical~G");
            g.addVertex("City Centre~G");
            g.addVertex("Central Park~G");
            g.addVertex("Karunamoyee~G");
            g.addVertex("Bandhan Bank Salt Lake Sector V~G");
            g.addVertex("Kestopur~G");
            g.addVertex("DumDum Park~G");
            g.addVertex("Baguiati~G");
            g.addVertex("Raghunatpur~G");
            g.addVertex("Teghoria/Haldiram~G");
            
            g.addEdge("Dakhineswar~B", "Baranagar~B", 5);
            g.addEdge("Baranagar~B", "Noapara~B", 10);
            g.addEdge("Noapara~B", "DumDum~B", 10);
            g.addEdge("DumDum~B", "Belgachia~B", 10);
            g.addEdge("Belgachia~B", "Shyambazar~B", 5);
            g.addEdge("Shyambazar~B", "Shobhabazar Sutanuti~B", 5);
            g.addEdge("Shobhabazar Sutanuti~B", "Girish Park~B", 5);
            g.addEdge("Girish Park~B", "Mahatma Gandhi Road~B", 5);
            g.addEdge("Mahatma Gandhi Road~B", "Central~B", 5);
            g.addEdge("Central~B", "Chandni Chowk~B", 5);
            g.addEdge("Chandni Chowk~B", "Esplanade~B", 5);
            g.addEdge("Esplanade~B", "Park Street~B", 5);
            g.addEdge("Park Street~B", "Maidan~B", 5);
            g.addEdge("Maidan~B", "Rabindra Sadan~B", 5);
            g.addEdge("Rabindra Sadan~B", "Netaji Bhavan~B", 5);
            g.addEdge("Netaji Bhavan~B", "Jatin Das Park~B", 5);
            g.addEdge("Jatin Das Park~B", "Kalighat~B", 5);
            g.addEdge("Kalighat~B", "Rabindra Sarobar~B", 5);
            g.addEdge("Rabindra Sarobar~B", "Mahanayak Uttam Kumar~B", 5);
            g.addEdge("Mahanayak Uttam Kumar~B", "Netaji~B", 5);
            g.addEdge("Netaji~B", "Masterda Surya Sen~B", 5);
            g.addEdge("Masterda Surya Sen~B", "Gitanjali~B", 5);
            g.addEdge("Gitanjali~B", "Kavi Nazrul~B", 5);
            g.addEdge("Kavi Nazrul~B", "Shahid Khudiram~B", 5);
            g.addEdge("Shahid Khudiram~B", "Kavi Subhash~B", 5);
            
            g.addEdge("Esplanade~B", "Phoolbagan~G", 5);
            g.addEdge("Phoolbagan~G", "IFA Salt Lake Stadium~G", 5);
            g.addEdge("IFA Salt Lake Stadium~G", "Bengal Chemical~G", 5);
            g.addEdge("Bengal Chemical~G", "City Centre~G", 5);
            g.addEdge("City Centre~G", "Central Park~G", 5);
            g.addEdge("Central Park~G", "Karunamoyee~G", 5);
            g.addEdge("Karunamoyee~G", "Bandhan Bank Salt Lake Sector V~G", 5);
            g.addEdge("Bandhan Bank Salt Lake Sector V~G", "Kestopur~G", 5);
            g.addEdge("Kestopur~G", "DumDum Park~G", 5);
            g.addEdge("DumDum Park~G", "Baguiati~G", 5);
            g.addEdge("Baguiati~G", "Raghunatpur~G", 5);
            g.addEdge("Raghunatpur~G", "Teghoria/Haldiram~G", 5);
        }
